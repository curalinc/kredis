...
module Kredis::Attributes
  ...
  class_methods do
    ...
    def kredis_cycle(name, values:, key: nil, default: nil, config: :shared, after_change: nil, expires_in: nil)
      kredis_connection_with __method__, name, key, values: values, default: default, config: config, after_change: after_change, expires_in: expires_in
    end
